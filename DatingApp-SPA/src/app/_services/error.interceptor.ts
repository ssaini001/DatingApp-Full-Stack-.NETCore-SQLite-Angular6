...
export const ErrorInterceptorProvider = {
    provide: HTTP_INTERCEPTORS,             // angular's own type of interceptors
    useClass: ErrorInterceptor,             // use class for interceptor
    multi: true                             // add to exiting angular interceptors
}